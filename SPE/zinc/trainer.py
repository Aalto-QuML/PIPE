...
#        )
        ...
        self.train_loader =  torch_geometric.data.DataLoader(train_dataset, batch_size=cfg.train_batch_size, shuffle=True)
        self.val_loader =  torch_geometric.data.DataLoader(val_dataset, batch_size=cfg.val_batch_size, shuffle=False)
        self.test_loader =  torch_geometric.data.DataLoader(test_dataset, batch_size=cfg.val_batch_size, shuffle=False)
    ...
    def train_epoch(self) -> float:
        self.model.train()
        total_loss = 0
        for self.curr_batch, batch in enumerate(self.train_loader):
